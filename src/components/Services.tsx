      ...
      <div className="container">
        ...
        <div className="fiverr-profile-card">
          <div className="profile-header">
            <div className="profile-avatar">
              <img src={`${import.meta.env.BASE_URL}images/profil.png`} alt="Sivasurya M" style={{width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover'}} loading="lazy" />
            </div>
        ...
        <div className="gigs-layout">
          ...
          <div className="gig-column">
            <a href={fiverrProfileUrl} target="_blank" rel="noopener noreferrer" className="gig-card" data-cursor="Open">
              <div className="gig-image-wrapper">
                <img src={`${import.meta.env.BASE_URL}images/gig_3d.png`} alt="3D Modeling Gig" className="gig-image" loading="lazy" />
            ...
            <div className="gig-portfolio">
              ...
              <div className="portfolio-grid" style={{gridTemplateColumns: 'repeat(3, 1fr)'}}>
                <div className="portfolio-item">
                  <img src={`${import.meta.env.BASE_URL}images/3D_Work_1.1.png`} alt="3D Work 1" loading="lazy" />
                </div>
                <div className="portfolio-item">
                  <img src={`${import.meta.env.BASE_URL}images/3D_Work_1.2.png`} alt="3D Work 2" loading="lazy" />
                </div>
                <div className="portfolio-item">
                  <img src={`${import.meta.env.BASE_URL}images/3D_Work_2.png`} alt="3D Work 3" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="gig-column">
            <a href={fiverrProfileUrl} target="_blank" rel="noopener noreferrer" className="gig-card" data-cursor="Open">
              <div className="gig-image-wrapper">
                <img src={`${import.meta.env.BASE_URL}images/gig_UI.png`} alt="UI Design Gig" className="gig-image" loading="lazy" />
                <div className="gig-overlay">
                  <ExternalLink size={32} color="#fff" />
                </div>
              </div>
            ...
            <div className="gig-portfolio">
              ...
              <div className="portfolio-grid" style={{gridTemplateColumns: '1fr'}}>
                <div className="portfolio-item" style={{height: '200px'}}>
                  <img src={`${import.meta.env.BASE_URL}images/UI_work.png`} alt="UI Work" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
